...
<%@page import="com.NaveenBlog.Dao.UserDao"%>
...
src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v17.0" nonce="pL0s9cyS"></script>
    </head>
    <body>
...
<!--comment facebook plugin-->
                            <div class="card-footer">
                                <div class="fb-comments" data-href="http://localhost:8080/NaveenBlog/show_blog_page.jsp?post_id=<%= p.getPid()  %>" data-width="" data-numposts="10"></div>
                          <!--end comment plugin-->
                            </div>
...
//                          }
        ...
        <!--//javascript for like module ( its seprate file is not working)-->
<!--        <script>
...
<div id="fb-root"></div>
<script async defer 
crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v17.0" nonce="TUuoQ1ao"></script>
    </body>
</html>
